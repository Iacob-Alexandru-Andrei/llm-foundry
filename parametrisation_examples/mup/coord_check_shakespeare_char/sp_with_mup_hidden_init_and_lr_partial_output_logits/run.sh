    ...
    do
        ...
        do
            ...
            do
                ...
                out_dir="mup/coord_check_shakespeare_char/sp_with_mup_hidden_init_and_lr_partial_output_logits/out/${optimizer}_h${n_heads}_eps${eps_flag}_peri${peri_flag}_width${width}_depth2_seed${seed}"
                if [ "$width" = 256 ]; then
