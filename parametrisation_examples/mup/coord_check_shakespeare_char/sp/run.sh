    ...
    do 
        ...
        do
            ...
            do
                        ...
                        out_dir="mup/coord_check_shakespeare_char/sp/out/${optimizer}_h${n_heads}_eps${eps_flag}_width${width}_depth2_seed${seed}_bs${bs}"

                        # Select beta_1, beta_2, adam_eps based on optimizer
                        if [ "$optimizer" == "decoupled_adamw" ]; then
                            echo "Using decoupled_adamw optimizer"
                            beta1=0.9
                            beta2=0.95
                            adam_eps=1e-8
                        elif [ "$optimizer" == "adopt" ]; then
                            echo "Using adopt optimizer"
                            beta1=0.9
                            beta2=0.9999
                            adam_eps=1e-6
                        fi
