    ...
    do
        ...
        do
            ...
            do
                ...
                out_dir="mup/coord_check_shakespeare_char/sp_with_mup_hidden_init/out/${optimizer}_h${n_heads}_eps${eps_flag}_peri${peri_flag}_width${width}_depth2_seed${seed}"
                python train.py \
                    --out_dir=$out_dir \
        --eval_interval=1 \
        --log_interval=1 \
